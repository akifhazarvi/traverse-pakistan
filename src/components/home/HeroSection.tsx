  ...
  return (
    <section className="relative flex flex-col items-center justify-center">
      ...
      >
        ...
        <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/10 backdrop-blur-sm rounded-[var(--radius-full)] border border-white/10 mb-6">
        ...
        <h1
          className="text-white leading-[1.02] tracking-[-0.04em] font-extrabold"
          style={{
        ...
        <p
          className="mt-5 text-[17px] sm:text-[19px] text-white/70 max-w-[520px] mx-auto leading-relaxed font-normal"
