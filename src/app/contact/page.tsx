          ...
          <div className="space-y-8">
            <div className="bg-[var(--bg-subtle)] rounded-xl p-6">
              ...
              <div className="space-y-4 text-[15px]">
                <div className="flex items-start gap-3">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#3E7A6E" strokeWidth="2" className="shrink-0 mt-0.5">
            ...
            <div className="bg-[#25D366]/10 border border-[#25D366]/30 rounded-xl p-6 text-center">
              ...
              <a
                ...
                className="inline-flex items-center gap-2 h-12 px-8 bg-[#25D366] text-white font-semibold rounded-full hover:bg-[#1fb855] transition-colors"
              >
